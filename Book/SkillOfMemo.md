...
|활용법|내용|비고|
|:---|:---|:---|
|1.보관|노트를 항상 자신의 몸옆에 둬라|  |
|2.선택|마음에 드는 디자인을 선택|  |
|3.주인의식|노트에 주인임을 나타내는 이름을 붙여라|  |
|4.인식구체화|a.페이지 맨 위에 큼직한 제목을 붙여라<br>b.항목을 세분화하여 명확한 문제를 명확하게 인식하라|  |
|5.삼색볼펜| 빨강(매우중요), 파랑(중요), 초록(흥미)|  |
|6.도식화|이진트리형식/ 말풍선/ 벤다이어그램/ 포지셔닝맵|  |
|7.간단명료|포인트는 세가지로 정리   |  |
|8.날짜|대화상대의 이름을 적어도 좋다.<br>결국, 인생의 연대기를 적는 일이다.| |
|9.단권화|노트는 한권이면 된다.||
|10.책또한 메모장| 책을 노트처럼 활용한다.||
