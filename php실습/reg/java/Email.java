...
public class Email {
	...
	public static void main(String[] args) {
		...
		String emailAddr[] 
					  = {"wonjin@bizspring.co.kr"
						,"test_mail-1004@james.com"
						,"testMail-1004@james-test.com"
						,"test.Mail-1004@james-test.co.kr"};
		for(String elem : emailAddr) {
			System.out.println("email address 테스트 결과 ==> " + elem.matches(regExp));
		}
	}
